    ...
    <nav className="flex items-center justify-between">
      <div className="flex justify-center flex-row max-md:flex-col max-md:text-center items-center z-10 max-md:pl-5 relative">
        ...
        <div className="flex flex-col max-md:text-xs max-md:text-center font-inter max-md:absolute top-3/4 whitespace-nowrap">
          ...
          <span className="text-2x1 font-bold">7x Support Prayer</span>
        </div>
      </div>
      <div
        className={`flex flex-1 justify-end max-md:h-screen font-inter mr-8 max-md:w-screen max-md:absolute max-md:justify-center left-0 max-md:py-0 py-4 max-md:pl-0 pl-7 duration-500 items-center ${
