...
function BodySite() {
  return (
    <div id='container' className="flex font-inter items-start justify-start md:ml-16 ml-5">
      <div id='container' className="flex flex-col mt-44">
        ...
        <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md w-64 h-14">
          Peça sua oração
        </button>
